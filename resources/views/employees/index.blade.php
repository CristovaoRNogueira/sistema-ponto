    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
                <form action="{{ route('employees.import_csv') }}" method="POST" enctype="multipart/form-data" class="m-0 p-0">
                    @csrf
                    <input type="file" name="csv_file" id="csv_file" class="hidden" accept=".csv" onchange="this.form.submit()">
                    <label for="csv_file" class="cursor-pointer inline-flex items-center px-3 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 transition ease-in-out duration-150 shadow-sm" title="Importar arquivo CSV do relógio">
                ...
                <a href="{{ route('employees.export_csv') }}" class="inline-flex items-center px-3 py-2 bg-emerald-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-700 active:bg-emerald-900 transition ease-in-out duration-150 shadow-sm" title="Baixar lista para Pen Drive">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('employees.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 transition ease-in-out duration-150 shadow-sm">
                    + Novo Servidor
                </a>
            </div>
        </div>
