...
<head>
    ...
    <title>{{ config('app.name', 'Sistema de Ponto') }} - Prefeitura</title>
...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        ...
        <nav class="flex items-center justify-end gap-4">
            ...
            <a
                href="{{ url('/dashboard') }}"
                class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm font-semibold leading-normal transition">
                Ir para o Dashboard
            </a>
            @else
            <a
                href="{{ route('login') }}"
                class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] text-[#1b1b18] border border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-sm font-semibold leading-normal transition">
                Entrar
            </a>
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row shadow-lg rounded-lg overflow-hidden">
            <div class="text-[13px] leading-[20px] flex-1 p-8 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none flex flex-col justify-center">

                <h1 class="mb-2 text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Sistema de Ponto Eletrônico</h1>
                <p class="mb-8 text-base text-[#706f6c] dark:text-[#A1A09A]">
                    Prefeitura Municipal de Carinhanha <br>
                    Gestão unificada de jornadas, batidas e espelhos de ponto.
                </p>

                <ul class="flex flex-col mb-8 lg:mb-10 space-y-2">
                    <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                        <span class="relative py-1 bg-white dark:bg-[#161615]">
                            <span class="flex items-center justify-center rounded-full bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] w-3.5 h-3.5 border dark:border-[#3E3E3A] border-[#e3e3e0]">
                                <span class="rounded-full bg-indigo-500 w-1.5 h-1.5"></span>
                            </span>
                        </span>
                        <span class="text-sm">
                            Já possui acesso?
                            <a href="{{ route('login') }}" class="inline-flex items-center space-x-1 font-bold underline underline-offset-4 text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 ml-1 transition">
                    ...
                    <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                        <span class="relative py-1 bg-white dark:bg-[#161615]">
                            <span class="flex items-center justify-center rounded-full bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] w-3.5 h-3.5 border dark:border-[#3E3E3A] border-[#e3e3e0]">
                                <span class="rounded-full bg-gray-400 dark:bg-gray-600 w-1.5 h-1.5"></span>
                            </span>
                        </span>
                        <span class="text-sm text-gray-500 dark:text-gray-400">
                            Primeiro acesso?
                            <a href="{{ route('register') }}" class="inline-flex items-center space-x-1 font-medium hover:underline underline-offset-4 text-gray-700 dark:text-gray-300 ml-1 transition">
                ...
                <div class="mt-auto">
                    @auth
                    <a href="{{ url('/dashboard') }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 shadow-md transition w-full sm:w-auto">
                        Entrar no Painel
                    </a>
                    @else
                    <a href="{{ route('login') }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 shadow-md transition w-full sm:w-auto">
                        Acessar o Sistema
                    </a>
                    @endauth
                </div>
            ...
            <div class="bg-indigo-50 dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                ...
                {{-- Arte abstrata moderna (mantendo o estilo original mas em tons de azul/índigo) --}}
                <svg class="w-full text-indigo-500 dark:text-indigo-700 transition-all translate-y-0 opacity-80 max-w-none duration-750 starting:opacity-0 starting:translate-y-6 relative z-10" viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg">
